            ...
            <div>
                ...
                <Dialog onClose={handleClose} open={open}>
                    ...
                    <DialogContent dividers>
                        ...
                        {
                            `제1조(목적)
이 약관은 페플 회사(전자상거래 사업자)가 운영하는 페플 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
                            
「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①"몰" 이란 페플 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 페플 사이버몰의 초기 서비스화면(전면)
...
25조(적립금)
① 적립금은 "페플"내에서 회원에 한하여 현금처럼 사용되는 사이버머니 이며, 구매금액 및 배송료 결제에 이용 할 수 있습니다.

② 적립해드린 적립금은 현금으로 지급/환불되지 않습니다.(단,무통장입금으로 결제하신 금액을 적립금으로 환불 받으신 경우는 제외)

③ 특별한 경우 적립금 사용이 제한될 수 있습니다. (예, 기획세일)

④ 구매를 통해 적립된 적립금은 해당 구매가 취소될 경우 회사에 의해 환수될 수 있습니다.

⑤ 적립금 총 누적금액에 상관없이 가지고계신 적립금은 사용이 가능합니다.

⑥ 이벤트를 통해서 적립된 적립금은 일정기간이 지나면 소멸될 수 있습니다.

26조(회원등급제)
①회원등급제는 "페플"에서 정한 회원등급기준의 의해서 적용이 되며 등급별 혜택이 다릅니다.

②회원등급기준과 등급별 혜택은 변경될 수 있습니다.

③회원등급별 혜택은 회원등급제 시행 이전 주문에 대해서는 적용되지 않습니다.

본 약관은 2002년12월02일부터 적용됩니다.`}
                            </textarea> 
                    </DialogContent>
                    <DialogActions>
